 ...
 */
class NlTokenizerTest extends UnitTest
{
    /**
     * Each test we set up a new Dutch Tokenizer object
     */
    public function setUp()
    {
        $this->test_objects['FILE1'] = PhraseParser::getTokenizer("nl");
    }
    /**
    ...
    /**
     * Tests whether the stem funtion for the Dutch stemming algorithm
     ...
     *
     * $test_words is an array containing a set of words in Dutch provided in
     * the snowball web page
     * $stem_words is an array containing the stems for words in $test_words
     */
    public function stemmerTestCase()
    {
        $stem_dir = C\PARENT_DIR.'/tests/test_files/dutch_stemmer';
