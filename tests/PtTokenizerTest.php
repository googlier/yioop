 ...
 */
class PtTokenizerTest extends UnitTest
{
    /**
     * Each test we set up a new Portuguese Tokenizer object
     */
    public function setUp()
    {
        $this->test_objects['FILE1'] = PhraseParser::getTokenizer("pt");
    }
    /**
    ...
    /**
     * Tests whether the stem funtion for the Portuguese stemming algorithm
     ...
     *
     * $test_words is an array containing a set of words in Portuguese provided
     * in the snowball web page
     * $stem_words is an array containing the stems for words in $test_words
     */
    public function stemmerTestCase()
    {
        $stem_dir = C\PARENT_DIR.'/tests/test_files/portuguese_stemmer';
